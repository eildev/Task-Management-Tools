        ...
        const openActiveDropdown = () => {
            ...
            allDropdowns.forEach((dropdown) => {
                ...
                submenuLinks.forEach((link) => {
                    if (link.getAttribute("href") === url || link.getAttribute("to") === url) {
            ...
            >
                ...
                <div className="sidebar-menu-area">
                    <ul className="sidebar-menu" id="sidebar-menu">
                        ...
                        <li>
                            <Link href="/" className={url === "/" ? "active-page" : ""}>
                        ...
                        <li className="dropdown">
                            ...
                            <ul className="sidebar-submenu">
                                <li>
                                    <Link href="/task" className={url === "/task" ? "active-page" : ""}>
                                        <i className="ri-circle-fill circle-icon text-primary-600 w-auto" />
                                        Create Task
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/task-manage" className={url === "/task-manage" ? "active-page" : ""}>
                 ...
                 {(user?.role === 'admin' || user?.role==='superadmin') && (
                        <li className="dropdown">
                            ...
                            <ul className="sidebar-submenu">
                                <li>
                                    <Link href="/users/index" className={url === "/users/index" ? "active-page" : ""}>
                                        <i className="ri-circle-fill circle-icon text-primary-600 w-auto" />
                                        Manage User
                                    </Link>
                                </li>
                                ...
                                <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu to-top dropdown-menu-lg p-0">
                                        ...
                                        <div className="max-h-400-px overflow-y-auto scroll-sm pe-4">
                                            <Link href="#" className="px-24 py-12 d-flex align-items-start gap-3 mb-2 justify-content-between">
                                        ...
                                        <div className="text-center py-12 px-16">
                                            <Link href="#" className="text-primary-600 fw-semibold text-md">See All Message</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu to-top dropdown-menu-lg p-0">
                                        ...
                                        <div className="text-center py-12 px-16">
                                            <Link href="#" className="text-primary-600 fw-semibold text-md">See All Notification</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu to-top dropdown-menu-sm">
                                        <div className="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                                            <div>
                                                <h6 className="text-lg text-primary-light fw-semibold mb-2">{user.name || "Shaidul Islam"}</h6>
